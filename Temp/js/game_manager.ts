...
class GameManager {
    ...
    moveTile(tile: Tiles.Tile, cell: Tiles.TilePosition) {
...
function positionsEqual(left: Tiles.TilePosition, right: Tiles.TilePosition): boolean {
